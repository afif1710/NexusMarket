    ...
    <div className="min-h-screen flex items-center justify-center py-12 px-4" data-testid="register-page">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-muted-foreground mt-2">Join NexusMarket today</p>
        </div>
        ...
        <div className="bg-card border border-border rounded-2xl p-6 space-y-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              >
                <div className={`flex items-center space-x-2 p-3 rounded-lg border cursor-pointer ${form.role === 'customer' ? 'border-primary bg-primary/5' : 'border-border'}`}>
                ...
                <div className={`flex items-center space-x-2 p-3 rounded-lg border cursor-pointer ${form.role === 'seller' ? 'border-primary bg-primary/5' : 'border-border'}`}>
